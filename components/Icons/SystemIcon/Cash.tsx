...
const CashIcon = ({ width = 24, height = 24, color, ...props }: Props) => {
  return (
    <svg
      {...props}
    ...
    >
      <defs>
        <clipPath id="clip-path">
          <PathColor id="사각형_28930" d="M0 0H35.64V38.252H0z" fill={color} />
        </clipPath>
      </defs>
      <path id="사각형_1955" fill="none" d="M0 0H50V50H0z" />
      <g id="그룹_37291" transform="translate(7.361 6.254)">
