    ...
    <ThemeConsumer>
      {(theme) => (
        ...
        >
          ...
          <path
            id="패스_264688"
            d="M-3453.872-2216.982l2.432-2.073 3.264 3.7-2.489 2.133z"
            fill={theme.color.PRIMARYSUB}
            transform="translate(3528.105 2263.327)"
          />
          <path
            id="패스_264687"
            d="M-3466.865-2197.921l1.244-4.763 14.081-13.477 3.044 3.25-14.244 13.869z"
            fill={theme.color.PRIMARYSUB}
            transform="translate(3525.664 2262.161)"
          />
          <path
            id="패스_264686"
            d="M-3485.824-2221.7l8.16-8.339v8.69z"
            fill={theme.color.PRIMARYSUB}
            transform="translate(3520.178 2258.144)"
          />
          <rect
            id="사각형_28855"
            width="16.762"
            ...
            fill={theme.color.PRIMARYSUB}
            rx="3"
            transform="translate(33.482 72.639)"
          />
