    ...
    <ThemeConsumer>
      {(theme) => (
        <svg
          ...
          id="duotone_call_popup_icon_100"
          width={size}
          height={size}
          viewBox="0 0 100 100"
        >
          ...
          <path
            ...
            stroke={theme.color.ICONSUB}
            d="M-3680.783-13849.768l3.537-4.425 3.12-2.24 2.7.815 5.475 5.85v2.957l-2.83 3.956-1.057 2.889 1.057 3.6 2.83 5.735 4.306 4.784 4.369 3.113 3.848 1.13 3.288-1.13 4.9-3.113 2.071-1.133 6.38 5.974 1.036 2.343-1.036 2.771-3.266 3.4-5.184 2.273-5.543.828-5.94-1.68-8.7-4.823-6.741-5.711-5.082-7.178-3.537-6.81-1.475-7.265z"
            transform="translate(3706 13890)"
          />
          <path
            id="패스_264814"
            fill="none"
            ...
            stroke-width="7px"
            d="M-3630.966-13847.275s3.578 10.591-2.314 19.606"
            transform="translate(3706 13890)"
          />
